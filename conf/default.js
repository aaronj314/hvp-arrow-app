...
module.exports = {
	...
	admin: {
		...
		validEmails: ["ajones@axway.com"],
		// set the organization ids you want to be able to log in to the admin website
		validOrgs: [68546560127288]
	},

	// you can generally leave this as-is since it is generated for each new project you created.
	session: {
		encryptionAlgorithm: 'aes256',
		encryptionKey: '8JJzWnYm4cNzNNRLSratDc/MReBAXo0NzA+UY/jALJM=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'yeLBsl/keP1sB+qj18N+7o+UXsUcubbK226lGP3G08dogH9sNpRr2+5SkniaBDq4MEeyx3SVk/SAy5iZguVo2w==',
		secret: 'zJ6S0HKHXlTzlgWZAyD6fMT/fE7Q9HTn', // should be a large unguessable string
	...
	cookieSecret: 'KHD0Vr5rU/cTKR4Yh0McWPbQM0dXC+BI',
